      ...
      <section className="py-24 md:py-32">
        <div className="container-page">
          <Reveal className="mb-16 max-w-3xl">
            ...
            <h2 className="h-display text-5xl text-graphite md:text-6xl">Ce que vous pouvez attendre de nous.</h2>
          </Reveal>
          <RevealGroup className="grid gap-5 md:grid-cols-2">
            {engagements.map((e, i) => (
              <RevealItem key={e.title} className="rounded-2xl border border-graphite/10 bg-blanc p-8 md:p-12">
                ...
                <h3 className="h-display mt-6 text-4xl text-graphite">{e.title}</h3>
      ...
      <section className="bg-graphite py-24 text-white md:py-32">
        <div className="container-page grid gap-12 lg:grid-cols-3">
          <Reveal className="lg:col-span-1">
            ...
            <h2 className="h-display text-5xl">Une entreprise installée, une équipe stable.</h2>
          </Reveal>
          <RevealGroup as="dl" className="grid gap-10 sm:grid-cols-2 lg:col-span-2">
            {[
              ...
              <RevealItem key={k} className="border-l border-white/15 pl-6">
                <dt className="h-display text-3xl">{k}</dt>
        ...
        <div className="container-page">
          <Reveal className="mb-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="h-display text-5xl text-graphite md:text-6xl">De la consultation à la réception.</h2>
            </div>
